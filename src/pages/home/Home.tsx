...
export const Home = () => {
  ...
  return (
    <div className="sm:px-16 md:px-2 mt-2 mb-2 lg:px-20 px-5">
      <div className="flex flex-col justify-center items-center">
        <div className="titulo m-4">
          <h1 className="text-zinc-900 font-great text-center text-3xl md:text-4xl">
            To Do List
          </h1>
        </div>
        ...
        <div className="conteudo_principal w-full flex flex-col md:flex-row md:items-start items-center justify-between gap-3 md:gap-6 sm:px-2 font-poppins">
          ...
          <div className="cards w-full space-y-2 sm:w-3/6 font-poppins">
            <div className="notes w-full rounded-lg border-2 p-2 bg-secondary text-center">
              <h2 className="font-light">Atrasadas</h2>
              <ul>
                {getOverdueTasks().map((task) => (
                  <li key={task.id} className="flex items-center justify-between border-b p-2 rounded">
